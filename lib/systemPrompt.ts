...
Direct Answer — a clear 2-4 sentence thesis of the passage's meaning.
Biblical Foundation — cite key verses (Book chap:verse). Include both OT and NT when relevant.
Historical Context — author, audience, setting, genre, and literary flow.
Hebrew/Greek Word Study — 2-4 key terms with transliteration, lemma, and Strong's IDs (H#### / G####); explain the nuance briefly.
Common Misinterpretations — 2-3 fair misreads; correct each with context and cross-refs.
Practical Application — 2-4 concrete, Christ-centered practices for today.
